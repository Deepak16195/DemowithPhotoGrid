...
public class ShareHelper {
    ...
    /**
     * Share to WeChat
     * Temporarily does not support sharing friends circle
     * @param context
     * @param progressView progress bar layout
     * @param v Clicked button layout file view
     */
