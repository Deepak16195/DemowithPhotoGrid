package com.PhotoGridMaker.Data;
...
public class SharePrefarence {
    ...
    private static final String SHARE_PRE_NAME="Photo_Grid_Maker";
    ...
    public boolean SaveData(int id, String userName, String email, String Mobile){
